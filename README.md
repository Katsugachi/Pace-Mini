...
## Instructions
Super easy. Just download pace_mini.py and double click it on windows and everything should be done. <br><br>On mac, cd~/path and run `python3 pace_mini.py`
## Download
...
**Parameters**: 350M (~229mb) <br>

**Setup**: 1-2 min (Varies based off device and internet speed) <br>

**Size**: 229mb + 15-20mb. <br>

**Speed**: 150+ tokens per second (Essentially instant) <br>
